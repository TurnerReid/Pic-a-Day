...
class DateCollectionViewCell: UICollectionViewCell {
    ...
    func DrawCircle() {
        ...
        let circlePath = UIBezierPath(arcCenter: circleCenter, radius: (Circle.bounds.width/2 - 0), startAngle: -CGFloat.pi/2, endAngle: (2 * CGFloat.pi), clockwise: true)
